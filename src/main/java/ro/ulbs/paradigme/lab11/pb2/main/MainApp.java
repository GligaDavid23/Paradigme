package ro.ulbs.paradigme.lab11.pb2.main;

import ro.ulbs.paradigme.lab11.pb2.storage.DataAggregator;
import ro.ulbs.paradigme.lab11.pb2.storage.DataRepository;
import ro.ulbs.paradigme.lab11.pb2.storage.DecoratedSensorData;
import ro.ulbs.paradigme.lab11.pb2.storage.SensorData;
...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        dataRepository.addData(new SensorData(4000, baseTimestamp - 60000));
